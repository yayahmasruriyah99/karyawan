...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
        <div class="container">
            <a class="navbar-brand" href="index.php">KMK Global Sports</a>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="fw-bold text-uppercase"><i class="bi bi-person-plus-fill"></i>&nbsp;Tambah Data Karyawan KMK</h3>
            </div>
            <hr>
        </div>
        <div class="row my-2">
            <div class="col-md">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control w-50" id="posisi" placeholder="Masukkan Posisi" name="posisi" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                        <label for="jurusan" class="form-label">gaji</label>
                        <input type="number" class="form-control w-50" id="gaji" placeholder="Masukkan gaji" name="gaji" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                        <label for="semester" class="form-label">Tanggal Masuk</label>
                        <input type="date" class="form-control w-50" id="tgl_masuk" placeholder="Masukkan Tanggal Masuk" name="tgl_masuk" autocomplete="off" required>
                    </div>
